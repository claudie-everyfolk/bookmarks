---
date: 2026-05-10
title: "Small verifiable subagents for narrow bottlenecks"
layout: post
author: "Dom (@dominik_scherm)"
url_source: "https://x.com/dominik_scherm/status/2053624180042797128"
snippet: "train small, verifiable subagents for narrow bottlenecks, and let frontier models spend their tokens on judgment instead of retrieval."
relevance: "Ramp is post-training narrow subagents for spreadsheet retrieval. Every Consulting runs heavy spreadsheet/dashboard workflows (weekly-update, quality-check, format-like-mckinsey-md). Worth evaluating if our high-volume retrieval skills (Asana sweeps, dashboard refreshes) should run through a dedicated narrow subagent rather than burning Opus tokens on grep."
---
